...
/**
 * @brief Basic implementation of a VehicleObstacleShadowingMmWave which inherits from VehicleObstacleShadowing class
 *
 * @ingroup analogueModels
 */
class VehicleObstacleShadowingMmWave : public VehicleObstacleShadowing {
...
public:
     ...
     */
    VehicleObstacleShadowingMmWave(cComponent* owner, VehicleObstacleControl& vehicleObstacleControl, bool useTorus, const Coord& playgroundSize);
    ...
    bool vehicleInBetweenDZ(const std::vector<std::pair<double, double>>& dz_vec);
};
